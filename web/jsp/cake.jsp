...
<div id="TopMain">
    ...
    <div id="Top">
        ...
        <div class="user">
            ...
            <!--用户登录后状态-->
            <a href="" class="usertxt">用户中心</a>｜<a href="" class="usertxt">退出</a>
...
<div id="Logo" >
    <ul>
        ...
        <li><a href="../WEB-INF/index.jsp" target="_blank">首页</a></li>
        <li><a href="product.jsp" target="_blank">节日礼物</a></li>
        <li><a href="">鲜花</a></li>
        <!--<li><a href="">生日礼物</a></li>
        <li><a href="">蛋糕</a></li>
        <li><a href="">商务礼物</a></li>
...
<div id="webIntro">
    <div class="webIntroCon">
        ...
        <div class="hotIntro">
            ...
            <div class="hotList">
                <dl>
                    <dt><a href="goods.jsp" target="_blank"><img src="images/webpic1.jpg" /></a></dt>
